package com.dlu.cdmanage.utils;
    ...
    public static void main(String[] args) {
       ...
       /* //全局配置
        ...
        dsConfig.setDbType(DbType.MYSQL)//数据库类型
                .setUrl("jdbc:mysql://localhost:3306/cd_management?useUnicode=true&serverTimezone=GMT&useSSL=false&characterEncoding=utf8")  //url
        ...
        pkConfig.setParent("com.dlu.cdmanage");//放在哪个包下
